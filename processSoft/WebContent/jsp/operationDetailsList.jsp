	...
	<head>
		...
		<div class="row header_margin_top">
  		...
  		<script type="text/javascript">
  			function Back()
  			{
  				window.location = "operationDetails.jsp";
  			}
  			function deletOperation()
    		 {
    		 window.location = "deletOperation.jsp";
    		 }
  		</script>
	</head>
	<script type="text/javascript"> 
			...
			<tbody>
   				<%
					for(int i=0;i<list12.size();i++){
						OperationDetailsBean sr=(OperationDetailsBean)list12.get(i);
				%>
				<tr>

...
<script src="//maxcdn.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>
    ...
    <link href="/processSoft/staticContent/css/dashboard.css" rel="stylesheet">
    
    <!-- Custom CSS -->
    <link href="/processSoft/staticContent/css/sb-admin-2.css" rel="stylesheet">
    
    <!-- Morris Charts CSS -->
    <link href="/processSoft/staticContent/css/morris.css" rel="stylesheet">
    
     <!-- MetisMenu CSS -->
    <link href="/processSoft/staticContent/css/metisMenu.min.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="/processSoft/staticContent/css/timeline.css" rel="stylesheet">
    ...
    <script src="/processSoft/staticContent/js/raphael-min.js"></script>
    <script src="/processSoft/staticContent/js/morris.min.js"></script>
    <script src="/processSoft/staticContent/js/morris-data.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="/processSoft/staticContent/js/sb-admin-2.js"></script>
    <script src="/processSoft/staticContent/js/logout.js"></script>
    
    <script src="/processSoft/staticContent/js/graph.js"></script>
<script src="/processSoft/staticContent/js/jquery-1.12.3.min.js"></script>
<script src="/processSoftr/staticContent/js/highcharts.js"></script>
<script src="/processSoft/staticContent/js/exporting.js"></script>
  <style>
.alert {
    padding: 20px;

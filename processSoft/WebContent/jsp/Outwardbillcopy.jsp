		...
		<div class="row form-group" style="margin-top: 20px">
			...
			<div class="col-md-4">
				<div class="input-group">
					...
					%>
					<input type="text" id="VendorName" list="cust_drop1" class="form-control" onchange="getVendorWiseBillNO1()">
			...
			<!-- <div class="row form-group buttons_margin_top">
				<div class="col-md-2">
					<div class="input-group">
						<div align="center">
							<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="BillCopy1()" value="Print" />
						</div>
					</div>
				</div>
			</div> -->

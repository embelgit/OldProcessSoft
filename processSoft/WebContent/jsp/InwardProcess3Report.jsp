<!-- InwardProcess3List.jsp -->
<%@page import="com.Fertilizer.bean.InwardProcess3Bean"%>
...
<html>
	<head>
		<title>Inward Process 3 Report</title>
		...
		%>
			  		<h2 class="form-name style_heading"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("godownDetails") %> <%}%> <%if(abc.equals("english")){%> Inward Process 3 <%=operationName%> Report <%}%> </h2>
			  	</div>		 
    </div>
  		<script type="text/javascript">
  			function Back()
  			{
  				window.location = "InwardProcess3.jsp" ;
  			}
			...
			<tbody>
   				<%
					for(int i=0;i<list12.size();i++){
						InwardProcess3Bean sr=(InwardProcess3Bean)list12.get(i);
				%>		
				<tr>

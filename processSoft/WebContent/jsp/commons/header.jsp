  ...
  <ul class="menu" style="margin-top: 2px;">
    ...
    <li><a href="" ><i class="fa fa-address-book-o"></i><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("master") %> <%}%> <%if(abc.equals("english")){%>Master<%}%></a>
      <ul class="sub-menu">
				...
				<li><a href="<%=path%>product_detail.jsp" accesskey="p"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("productDetails") %> <%}%> <%if(abc.equals("english")){%>Product Details<br>Access Key = p<%}%></a></li>
				<li><a href="<%=path%>supplierdetails.jsp" accesskey="v"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("supplierdetails") %> <%}%> <%if(abc.equals("english")){%>Vendor Details<br>Access Key = v<%}%></a></li>
				<li><a href="<%=path%>employee_detail.jsp" accesskey="e" ><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("employeeDetails") %> <%}%> <%if(abc.equals("english")){%>Employee Details<br>Access Key = e<%}%></a></li>
				...
				<li><a href="<%=path%>expenditureDetails.jsp" accesskey="x"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("expenditureDetails") %> <%}%> <%if(abc.equals("english")){%>Expenditure Details<br>Access Key = x<%}%></a></li>
				<li><a href="<%=path%>operationDetails.jsp" accesskey="o"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("operationDetails") %> <%}%> <%if(abc.equals("english")){%>Operation Details<br>Access Key = o<%}%></a></li>
				<%-- <li><a href="<%=path%>expenseDetailsForBillingAndGoodsReceive.jsp"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("expenditureDetails") %> <%}%> <%if(abc.equals("english")){%>Expense Details For Blling<%}%></a></li> --%>
				 <li><a href="<%=path%>tax.jsp" accesskey="t"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("taxDetails") %> <%}%> <%if(abc.equals("english")){%>Tax Details<br>Access Key = t<%}%></a></li> 
					 <%-- <li><a href="<%=path%>TaxEdit.jsp">Edit Tax Details</a></li>  --%>
				 <li><a href="<%=path%>measuringUnits.jsp" accesskey="m"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("measuringUnits") %> <%}%> <%if(abc.equals("english")){%>Measuring Units Entry<br>Access Key = m<%}%></a></li>
				...
				<li><a href="<%=path%>shopdetails.jsp" accesskey="s"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("shopdetails") %> <%}%> <%if(abc.equals("english")){%>Shop Details<br>Access Key = s<%}%></a></li>
	...
	<%}%>
	 ...
	 <li><a  href="#"><i class="fa fa-user-secret"></i><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("Purchase") %> <%}%> <%if(abc.equals("english")){%>Outward<%}%> </a>
     		<ul class="sub-menu">
     			...
     			<li><a href="<%=path%>OutwardStock.jsp" ><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("purchaseReturn") %> <%}%> <%if(abc.equals("english")){%>Outward Stock<%}%></a></li>								
    ...
    <li><a  href="<%=path%>allPaymentWithLeftTabs.jsp" accesskey="c"><i class="fa fa-edit"></i><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("cashBook") %> <%}%> <%if(abc.equals("english")){%>CashBook<%}%> </a>
    ...
    <%}%>
      ...
      <ul class="sub-menu">
								...
								<li><a  href="<%=path%>InwardProcess1Report.jsp" accesskey="i">Inward Process 1 Reports</a></li>
...
<script type="text/javascript">
	...
	shortcut.add("alt+o", function() {
		window.location.href = "operationDetails.jsp";
	});
	...
	//shop Details
	shortcut.add("alt+s", function() {
		window.location.href = "shopdetails.jsp";
	});

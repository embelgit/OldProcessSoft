...
<%
	...
	String outwardchallanno = (String)session.getAttribute("VendorBillNo");
...
/* 		Date billDate = new Date();
		...
		table_cell11 = new PdfPCell(new Phrase("Delivery Challan", font15Bold));
		...
		PdfPCell table_cell;
				...
				inwardChallan = rs.getString("challan_No");
			...
			table_cell = new PdfPCell(new Phrase("" +suppliername1 , font12));
			table_cell.setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			String outwarddate =rs.getString("outward_date");
			Date OutDate=new SimpleDateFormat("yyyy-MM-dd").parse(outwarddate); 
			 SimpleDateFormat dateFormater3 = new SimpleDateFormat("dd-MM-yyyy");
			 String OudDate = dateFormater3.format(OutDate);
			
			table_cell = new PdfPCell(new Phrase("Date : " + OudDate,font12NoBold));
			table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell.setBorder(Rectangle.RIGHT | Rectangle.TOP | Rectangle.BOTTOM);
			table_cell.setColspan(1);
			table.addCell(table_cell);
		...
		/* 	String VechicleNo = rs.getString("vechicleNo");
			...
			String inwordChallAn = rs.getString("challan_No");
		...
		table_cell3 = new PdfPCell(new Phrase("Ok Qty", Normalfont11));
		table_cell3.setBorderWidth(1f);
		table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell3.setPaddingBottom(4f);
		table3.addCell(table_cell3);
		...
		while (rs.next()) {
			...
			String manufacturing_company = rs.getString("outward_date");
			table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell3 = new PdfPCell(new Phrase(OudDate, font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM);
			table_cell3.setBorderWidth(1f);
			table_cell3.setPaddingTop(2);
			table_cell3.setPaddingBottom(2);
			...
			String hsnNumber = rs.getString("okquantity");
			table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
			...
			double weight = rs.getDouble("rejectedquantity");
			table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
		...
		/* 	
			...
			String quantity = rs.getString("unprocessquantity");
			...
			forTotal= Double.parseDouble(okQty);
			 ...
			 //ShopName =rs.getString("ShopName");
				...
				forrj = rs.getString("rejectedquantity");
	...
	System.out.println("hi this kishor---------"+rejectedquantity);
		...
		table_cell3 = new PdfPCell(new Phrase("Description:"+Dis, font12NoBold));
		table_cell3.setColspan(4);
		table_cell3.setHorizontalAlignment(Element.ALIGN_LEFT);

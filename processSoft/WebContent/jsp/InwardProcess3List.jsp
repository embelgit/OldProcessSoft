...
<html>
	<head>
		<title>Inward Process 3 List</title>
		...
		%>
			  		<h2 class="form-name style_heading"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("godownDetails") %> <%}%> <%if(abc.equals("english")){%> Inward Process 3 <%=operationName%> List <%}%> </h2>
			  	</div>		 
    </div>

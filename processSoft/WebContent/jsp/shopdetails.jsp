			 ...
			 <div class="row form-group" >
				...
				<div class="form-group row">
		           ...
		           <!--  "catDetails()" function is implemented in categoryDetails.js -->
		           	...
		           	<input type="button" id="submitBtn" name="submit" style="font-size: 20px;font-weight: 500;padding: 0 8px;width: 100px;height: 45px;" style="font-size: 25" class="btn btn-large btn-success button-height-width" onclick="shopDetails()" value="Submit">
		            <input style="font-size: 20px;font-weight: 500;padding: 0 8px;width: 100px;height: 45px;" type="reset" style="font-size: 25" class="btn btn-large btn-danger  button-height-width" id="save" name="btn" value="Cancel" onclick="reset()">

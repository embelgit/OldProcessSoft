				...
				<form class="form-horizontal" method="post" action=""
					...
					<fieldset>
						<div class="row form-group" style="margin-top: 20px">
							...
							<label class="col-md-2 control-label" for="ShopName1">Outward Challan
								No<sup>*</sup>
							</label>
							<div class="col-md-2">
								<div class="input-group">
									...
									<div class="input-group">
										<div align="center">
											<input type="button" id="btn" name="save"
												...
												onclick="OutwardReturnVendorNameWise()" value="Search" />
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row form-group">
							<div class="col-md-3 ">
								<div class="input-group">
									<input type="button" id="btn" name="save"
										class="btn btn-lg btn-success btn-md button_hw button_margin_right"
										onclick="OutwardReturnReportAsPerVendorNameWise()" value="Search" />
								</div>
							</div>
						</div>
						</div>

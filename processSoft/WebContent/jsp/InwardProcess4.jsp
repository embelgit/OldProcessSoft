...
<head>
<meta charset="utf-8">
<title>Inward Process 4</title>

<script type="text/javascript" src="/processSoft/staticContent/js/inwardProcess4.js"></script>


<script type="text/javascript">
function InwardProcess4List()
	 {
		document.getElementById('inwardProcess4ListBtn').disabled = true;
	 	window.location = "InwardProcess4List.jsp";
	 }
function editTax() {
...
<div class="row header_margin_top">
	<div class="bill-heading" align="center">
		...
		%>
		<h2 class="form-name style_heading">Inward Process 4 <%=operationName%></h2>
	</div>
</div>
<div class="row">
				...
				<div class="col-md-3">
 				<div class="input-group">
					<span class="input-group-addon">
						...
						<%
							InwardProcess4Dao cdd = new InwardProcess4Dao();
...
<!-- 						<input list="cat_drop" id="taxType"  class="form-control" onchange="checkForDuplicateTAXEntry()"> -->
            	...
            	<div class="input-group">
					<span class="input-group-addon"><i class="	glyphicon glyphicon-hand-right"></i></span>
							...
							<!-- getAllMainCat() is implemented in  CategoryDetailsDao with return type List-->
					<%
					InwardProcess4Dao cdd1 = new InwardProcess4Dao();
...
<!-- 					<input type="text" id="challanNo" name="challanNo" class="form-control"> -->
 				...
 				<div class="input-group">
					<span class="input-group-addon">
						<i class="	glyphicon glyphicon-hand-right"></i></span>
							...
							<!-- getAllMainCat() is implemented in  CategoryDetailsDao with return type List-->
						<%
						InwardProcess4Dao dao1 = new InwardProcess4Dao();
			...
			<div class="form-group row">
           		<div class="col-md-12 text-center">
					...
					<input type="button" id="saveInwardProcess4DetailsBtn" name="btn" style="font-size: 20px;font-weight: 500;padding: 0 8px;width: 100px;height: 45px;" class="btn btn-large btn-success   button-height-width" onclick="validationInwardProcess4Details()" value="Submit">
					...
					<input style="font-size: 20px;font-weight: 500;padding: 0 8px;width: 100px;height: 45px;" type="button" value="List" id="inwardProcess4ListBtn" class="btn btn-primary btn-large  button-height-width " onclick="InwardProcess4List()" /> 

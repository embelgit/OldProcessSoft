...
<!-- 					<input type="text" id="challanNo" name="challanNo" class="form-control"> -->
			...
			<div class="form-group row">
           		<div class="col-md-12 text-center">
					...
					<input type="button" id="saveInwardProcess4DetailsBtn" name="btn" style="font-size: 25" class="btn btn-large btn-success   button-height-width" onclick="validationInwardProcess4Details()" value="Submit">
					...
					<input style="  font-size: 25" type="button" value="List" id="inwardProcess4ListBtn" class="btn btn-primary btn-large  button-height-width " onclick="InwardProcess4List()" /> 

...
<%
	response.setContentType("application/pdf");
	  ...
	  String billno=(String)session.getAttribute("customerBill");
	  	
	  	System.out.println("////////////////////////////////////////////////+++++"+billno+" bbbbbbbbbbbbbbbbbbbbb");
		...
		//ResultSet rs = stmt.executeQuery("SELECT bd.creditcustomer,bd.product_name,bd.tax_amount,bd.address,bd.outwardchallan_no,bd.InwardChallanNo,bd.discount_Amount,bd.gst_No,bd.okquantity,bd.sale_Date,bd.buy_Price,bd.total,bd.gst,bd.Igst,bd.gross_Total,bd.vehicle,bd.description,bd.hsn,bd.Operation,bd.grid_Total,bd.ShopName,bd.custname,id.challandate FROM bill_details bd join inwand_details id WHERE bill_no ='"+billno+"' GROUP BY bd.pk_customer_id");

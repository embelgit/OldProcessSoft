...
<%@page import="com.Fertilizer.hibernate.SaleReturnBean"%>
<%
...
<script type="text/javascript" src="/processSoft/staticContent/js/fertiSaleReturn.js"></script>
				...
				<form class="form-horizontal" method="post" action=""
					...
					<fieldset>
						<div class="row form-group" style="margin-top: 20px">
							...
							<label class="col-md-2 control-label" for="fk_cat_id">Customer Name<sup>*</sup></label>
							<div class="col-md-3">
								<div class="input-group">
									...
									<%
									FertilizerBillDao DEO = new FertilizerBillDao();
										List Pod = DEO.getAllSaleReturnDetails();
									%>
									<input type="text" id="vendorName" list="Vendor_drop1" class="form-control">
									<datalist id="Vendor_drop1">
										<%
											for (int i = 0; i < Pod.size(); i++) {
												SaleReturnBean bean = (SaleReturnBean) Pod.get(i);
										%>
										<option data-value="<%=bean.getPkSaleReturnId()%>" value="<%=bean.getCustomerName()%> "></option>
										<%
											}
										%>
									</datalist>
							...
							<label class="col-md-2 control-label" for="ShopName1">Bill No<sup>*</sup></label>
							<div class="col-md-2">
								<div class="input-group">
									...
									%>
									<input list="ShopName_drop1" id="billNo" class="form-control" style="text-transform: uppercase">
									<datalist id="ShopName_drop1">
										<%
											for (int i = 0; i < ShopList2.size(); i++) {
												SaleReturnBean bean2 = (SaleReturnBean) ShopList2.get(i);
										%>
										<option data-value="<%=bean2.getPkSaleReturnId()%>" value="<%=bean2.getBillNo()%>">
											<%
												}
											%>
									</datalist>

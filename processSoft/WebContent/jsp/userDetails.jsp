...
<meta charset="utf-8">
<head>
<script type="text/javascript" src="/processSoft/staticContent/js/userDetails.js"></script>
	<script type="text/javascript">
	function openLogin(){
      ...
      <div class="col-sm-offset-2">
        <form class="form-horizontal" method="post" action="" name="usd"><!-- Value of 'name' attribute is used in userDetails.js  -->
          <fieldset>
			 ...
			 <div class="row form-group">
           		<label class="col-md-2 control-label" for="firstName">First Name<sup>*</sup></label>  
            			...
            			<div class="input-group">
							...
							%>
							<input list="firstName_drop" id="firstName" autofocus  class="form-control">
		            ...
		            <div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
	              			...
	              			<input id="userName" name="userName " placeholder="User Name" class="form-control input-md" type="text"  onchange="return ChooseContact();" >
	            		</div>
					</div>
			...
			<div  class="row form-group">
			<label class="col-md-2 control-label" for="pan">ShopName<sup>*</sup></label>  
           			 <div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
							<i class="glyphicon glyphicon-hand-right"></i>
              				...
              				<input id="shopname" name="shopname" placeholder="Shop Name" class="form-control input-md" type="text" required="">
            			</div>
            		</div>
			</div>
			<br>

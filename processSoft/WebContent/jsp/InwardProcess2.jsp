...
<head>
<meta charset="utf-8">
<title>Inward Process 2</title>

<script type="text/javascript" src="/processSoft/staticContent/js/inwardProcess2.js"></script>


<script type="text/javascript">
function InwardProcess2List()
	 {
		document.getElementById('inwardProcess2ListBtn').disabled = true;
	 	window.location = "InwardProcess2List.jsp";
	 }
function editTax() {
...
<div class="row header_margin_top">
	<div align="center">
		...
		%>
		<h2 class="form-name style_heading">Inward Process 2 <%=operationName%></h2>
	</div>
</div>
<div class="row">
				...
				<div class="col-md-3">
 				<div class="input-group">
					<span class="input-group-addon"><i class="	glyphicon glyphicon-hand-right"></i></span>
						...
						<%
							InwardProcess2Dao cdd = new InwardProcess2Dao();
...
<!-- 						<input list="cat_drop" id="taxType"  class="form-control" onchange="checkForDuplicateTAXEntry()"> -->
            	...
            	<div class="input-group">
					<span class="input-group-addon"><i class="	glyphicon glyphicon-hand-right"></i></span>
							...
							<!-- getAllMainCat() is implemented in  CategoryDetailsDao with return type List-->
					<%
					InwardProcess2Dao cdd1 = new InwardProcess2Dao();

...
<div class="tab-pane active" id="home">
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#BillCopy"><h4
					style="color: blue">Outward Return Bill Copy</h4></a></li>
	</ul>
</div>
		...
		<div class="row form-group" style="margin-top: 20px">
			...
			<div class="col-md-4">
				<div class="input-group">
					...
					%>
					<input type="text" id="VendorName" list="cust_drop1" class="form-control" onchange="getVendorWiseBillNO2()">
			...
			<label class="col-md-2 control-label" for="BillNum">Outward Challan No<sup>*</sup>
			</label>
			...
			<div class="col-md-4">
				<div class="input-group">
					...
					<select class="form-control selectpicker" id="OutwardChallanNo" name="Outward Challan No">
					</select>
				</div>
			</div>
			...
			<!-- <div class="row form-group">
				<div class="col-md-3">
					<div class="input-group">
						<div align="center">
							<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="OutwardReturnbill()" value="Print" />
						</div>
					</div>
				</div>
			</div> -->

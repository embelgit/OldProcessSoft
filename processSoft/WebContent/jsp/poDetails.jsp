...
<!--  -->
<link rel="stylesheet"
	href="/processSoft/staticContent/css/ui.jqgrid.css">
<!--  -->
<script type="text/javascript"
	src="/processSoft/staticContent/js/jquery.min.js"></script>
<script type="text/javascript"
	src="/processSoft/staticContent/js/jquery-ui-min.js"></script>
<script type="text/javascript"
	src="/processSoft/staticContent/js/jquery-ui.js"></script>
<script type="text/javascript"
	src="/processSoft/staticContent/js/jqueryUi.js"></script>
<script type="text/javascript"
	src="/processSoft/staticContent/js/jquery.jqgrid.min.js"></script>
...
function supplierlist(){
	document.getElementById('venderListBtn').disabled = true;
	window.location = "supplierList.jsp";
}
function editSupplier() {
	document.getElementById('editVenderDtlBtn').disabled = true;
...
function getEditProductDetails() {
	...
	window.location = "editProductDetails.jsp";
          		...
          		<%-- function checkForDuplicateSupplierIdEntry(){
          			...
          			<%-- function checkForDuplicateSupplierIdEntry(){
              			...
              			if(document.getElementById("suppliername").value ==supName ){
	...
	<div class="row header_margin_top">
		<div align="center">
			<h2 class="form-name style_heading">
				...
				<%}%>
				<%if(abc.equals("english")){%>Purchase Order Details<%}%>
			</h2>
		</div>
					...
					<div class="col-md-3 ">
						<div class="input-group">
							...
							<i
							  ...
							  <input id="IdNo"
								name="IdNo " autofocus="IdNo_1" placeholder="ID Number"
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="dealerName_drop" id="suppliername"
								class="form-control" onchange="getvenderDataForPDdetails();checkForDuplicateSupplierIdEntry();">
						...
						<div class="input-group">
							...
							<%
							  ...
							  /* ProductDetailsHelper productdao = new ProductDetailsHelper();
        						List productList =productdao.getAllProductDetails1(); */
							%>
							<input list="productName_drop" id="productName" autofocus="productName"
								class="form-control" onchange="productDetailInGrid()" 
								style="text-transform: uppercase" >
      ...
      <div class="container col-sm-offset-1" >
       ...
       <input style="  font-size: 25" type="button" value="Submit" id="saveSupplierDetailsBtn" name="btn" class="btn btn-large btn-success glyphicon glyphicon-save  button-height-width" onclick="supplierDetail()" /> 
        <input style=" font-size: 25" type="button" value="Cancel" id="save" name="btn" class="btn btn-large btn-danger glyphicon glyphicon-remove-circle  button-height-width" onclick="location.reload()" /> 
            	...
            	<input style=" font-size: 25" type="button" value="Vendor List" id="venderListBtn" class="btn btn-primary  btn-large  button-height-width " onclick="supplierlist()" /> 
              	<input style=" font-size: 25" type="button" value="Edit" id="editVenderDtlBtn" class="btn btn-primary  btn-large  button-height-width" onclick="editSupplier()" /> 
            </div>
          </div>
         </fieldset>
       </form>
...
">
		...
		<div class="form-group row">
            <div class="col-md-11 text-center">
            	...
            	<input style="  font-size: 25" type="button" value="Product List" id="ProductListBtn" class="btn btn-primary btn-large button-height-width" onclick="getProductList()" /> 
              	<input style="  font-size: 25" type="button" value="Edit" id="EditProductDtlBtn" class="btn btn-primary btn-large button-height-width " onclick="getEditProductDetails()" /> 
            </div>
          </div>
		</fieldset>
       </form>

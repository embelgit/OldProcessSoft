...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <script src="/processSoft/staticContent/js/bootstrap-select.min.js"></script>
  
  <link rel="stylesheet" href="/processSoft/staticContent/css/bootstrap.allPayment.min.css">
  <script src="/processSoft/staticContent/js/jquery.allPayment.min.js"></script>
  <script src="/processSoft/staticContent/js/bootstrap.allPayment.min.js"></script>
   <script src="/processSoft/staticContent/js/cashbankbook.js"></script>
   
 <!--   files for selectpicker -->
    <script src="/processSoft/staticContent/js/bootstrap-select.js"></script>
      <script src="/processSoft/staticContent/js/bootstrapForSelect.min.js"></script>
   
      <link rel="stylesheet" href="/processSoft/staticContent/css/bootstrap-select.css"> 
      <link rel="stylesheet" href="/processSoft/staticContent/css/bootstrap-select.min.css"> 
      <link rel="stylesheet" href="/processSoft/staticContent/css/bootstrapForSelect.min.css"> 

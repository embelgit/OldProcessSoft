        ...
        <form class="form-horizontal" method="post" action="" name="txc"><!-- Value of 'name' attribute is used in  taxCreation.js  -->
          <fieldset>
				...
				<div class="form-group row">
					...
					<input type="button" id="save" name="btn" style="font-size: 25" class="btn btn-large btn-success   button-height-width"  onclick="addtax() " value="Submit">

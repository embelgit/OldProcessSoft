...
function ShopNameWiseinwardReportValidation1() {
	...
	params["methodName"] = "getInwardDetailsTableforShopNamewithpo";
	
	//$inwardReportValidation()
...
function inwardreportDatewise() {
	...
	params["methodName"] = "getInwardDetailsDatewiseWithPo";
...
function productNameWiseinwardreporttable() {
	...
	// var fDate = $("#fDate").val();
	// params["fDate"]= fDate;
	params["methodName"] = "getInwardDetailsTableforProductNamewithpo";
...
function vendorNameWiseinwardreporttable() {
	...
	// var fDate = $("#fDate").val();
	// params["fDate"]= fDate;
	params["methodName"] = "getInwardDetailsTableforvendorNamewithpo";
